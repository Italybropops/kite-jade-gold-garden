...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bssnee-T.js
...
var TooltipContent = import_react.forwardRef(({ className, sideOffset = 6, ...props }, ref) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Content2, {
	ref,
	sideOffset,
	className: cn("z-50 overflow-hidden rounded-md border border-border bg-popover px-2.5 py-1.5 text-xs text-popover-foreground shadow-soft", className),
	...props
}) }));
TooltipContent.displayName = "TooltipContent";
var styles_default = "/assets/styles-C3pw24J5.css";
var APP_NAME = "Sift";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Analyze, summarize, and clean up your Grok chats."
			},
			{
				name: "theme-color",
				content: "#0b0b0c"
...
var $$splitComponentImporter = () => import("./routes-BcKL-lUX.mjs");
