...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BLJMaRGN.mjs");
...
var manifest = {
	"4c74e8a94d8aae636bcade95623a140d5a7e1dc8f3b029d6d38a6d8997ff5797": {
		functionName: "deepAnalyze_createServerFn_handler",
		importer: () => import("./deep-analyze-jAjwcbbr.mjs")
	},
	"e1af770be22146b2339e3b0bb28511ea191fb1384e8d184462f2eed77745cf41": {
		functionName: "summarizeChat_createServerFn_handler",
		importer: () => import("./deep-analyze-jAjwcbbr.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Bssnee-T.mjs").then((n) => n.t),
